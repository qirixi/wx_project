              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?=base_url();?>img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?=base_url();?>img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?=base_url();?>Dashboard/index"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>
        <li>
          <a href="<?=base_url();?>Categories/index">
            <i class="fa fa-th"></i> <span>分类</span>
          </a>
        </li>
        <li class="treeview">
          <a href="<?=base_url();?>Production/index">
            <i class="fa fa-th"></i> <span>商品</span>
            <span class="pull-right-container">
               <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?=base_url();?>Production/add_form"><i class="fa fa-circle-o"></i> 添加新品</a></li>
            <li><a href="<?=base_url();?>Stock/index"><i class="fa fa-circle-o"></i> 添加库存</a></li>
            <li><a href="<?=base_url();?>Production/index"><i class="fa fa-circle-o"></i> 商品列表</a></li>
        ...
        <li>
          <a href="<?=base_url();?>Categories/index">
            <i class="fa fa-th"></i> <span>评价管理</span>
            <span class="pull-right-container">
               <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i> 添加新券</a></li>
            <li><a href="pages/UI/icons.html"><i class="fa fa-circle-o"></i> 购物券管理</a></li>
          </ul>
        </li>
        <li>
          <a href="#">
  ...
  <div class="content-wrapper">
    <section class="content-header">
        <h1>
          ...
          <small> <?php echo $layout['small_title'];?></small>
        </h1>
        <ol class="breadcrumb">
