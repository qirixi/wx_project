(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            //chunkSize: 512 * 1024,
            server: '../Production/upload_image',
            method:'POST',
            // runtimeOrder: 'flash',
            ...
            fileNumLimit: 8,
            fileSizeLimit: 400 * 1024 * 1024,    // 40 M
            fileSingleSizeLimit: 50 * 1024 * 1024    // 5 M
        });
        ...
        uploader.on('uploadSuccess', function(file,response) {
            //file_array.push(response.data.imgUrl);
            //alert(response.data.imgUrl);
            parent.push_value(response.data.imgUrl);
        });
